    ...
    <div class="col s12 m6 l6 offset-l3 offset-m3">
      <div class="card white">
        <div class="card-content black-text">
          ...
          {{ Form::model($product,['method' => 'PATCH','route'=>['editP.update',$product->id]]) }}
          <div class="center">
                      ...
                      <div class="row">
                        <div class="col s12">
                          <div class="row">
                            ...
                            <div class="input-field col s6 @if ($errors->has('product_expiration')) red-text text-darken-3 @endif">
                              <br> <br>
                              <input id="product_expiration" name="product_expiration" type="date" class="datepicker" required="" maxlength="40" value="{{$product->product_expiration}}">
                              <label for="product_expiration">Expiration Date</label>
                              @if ($errors->has('product_expiration')) <p class="help-block">{{ $errors->first('product_expiration') }}</p> @endif
                            </div>
          ...
          <a href='/p'><button type="button" class=" waves-effect waves-light btn teal lighten-1">Back</button></a>
