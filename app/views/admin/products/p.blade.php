    ...
    <div class="card material-table">
      ...
      <table id="datatable">
        <thead>
                        ...
                        <td>
                         ...
                         <td>
                          ...
                          <a class="teal-text text-lighten-1 modal-trigger" data-toggle="modal" href="#SubtractProductQty{{$product->id}}">Deduct</button>
                            <a> / </a>
                          <a class="teal-text text-lighten-1 modal-trigger" data-toggle="modal" href="{{ URL::to('p/' . $product->id . '/edit') }}">Edit</button>
                        </td>
                     </tr>
                        @endforeach
                  </p>
          ...
          <a class="waves-effect waves-light btn teal lighten-1 modal-trigger" data-toggle="modal" href="{{ URL::to('p/create') }}">add</a>
          </div>
      <!-- END Products Table -->     
